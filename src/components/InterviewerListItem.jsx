...
export default function InterviewerListItem (props) {
  const conditionalClasses = classNames("interviewers__item-image", {"interviewers__item--selected": props.selected})
  const interviewerName = props.selected ? props.name : ""
  return (
    <li className={conditionalClasses} onClick={() => props.setInterviewer(props.id)}>
  <img
